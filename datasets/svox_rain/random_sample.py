...
if __name__ == "__main__":
    ...
    output_path = "/media/cartolab3/DataDisk/wuqilong_file/Projects/RerenkVPR/sample_imgs/svox_rain"
    # 获取当前文件的绝对路径
    ...
    dbImages = os.path.join(parent_path, "svox_rain_val_dbImages.npy")
    qImages = os.path.join(parent_path, "svox_rain_val_qImages.npy")
    qIdx = os.path.join(parent_path, "svox_rain_val_qIdx.npy")
    pIdx = os.path.join(parent_path, "svox_rain_val_pIdx.npy")
    num_pairs = 30
