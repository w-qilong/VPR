...
if __name__ == "__main__":
    ...
    root_path = "/media/cartolab3/DataDisk/wuqilong_file/VPR_datasets/nordland/images/test"
    output_path = "/media/cartolab3/DataDisk/wuqilong_file/Projects/RerenkVPR/sample_imgs/nordland"
    # 获取当前文件的绝对路径
    ...
    dbImages = os.path.join(parent_path, "nordland_test_dbImages.npy")
    qImages = os.path.join(parent_path, "nordland_test_qImages.npy")
    qIdx = os.path.join(parent_path, "nordland_test_qIdx.npy")
    pIdx = os.path.join(parent_path, "nordland_test_pIdx.npy")
    num_pairs = 30
