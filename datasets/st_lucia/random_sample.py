...
if __name__ == "__main__":
    ...
    root_path = "/media/cartolab3/DataDisk/wuqilong_file/VPR_datasets/st_lucia/images/test"
    output_path = "/media/cartolab3/DataDisk/wuqilong_file/Projects/RerenkVPR/sample_imgs/st_lucia"
    # 获取当前文件的绝对路径
    ...
    dbImages = os.path.join(parent_path, "st_lucia_val_dbImages.npy")
    qImages = os.path.join(parent_path, "st_lucia_val_qImages.npy")
    qIdx = os.path.join(parent_path, "st_lucia_val_qIdx.npy")
    pIdx = os.path.join(parent_path, "st_lucia_val_pIdx.npy")
    num_pairs = 30
