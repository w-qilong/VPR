...
def random_sample(root_path, output_path, dbImages, qImages, qIdx, pIdx, num_pairs):
    ...
    sampled_dbImages = dbImages[sampled_pIdx]
...
if __name__ == "__main__":
    ...
    root_path = "/media/cartolab3/DataDisk/wuqilong_file/VPR_datasets/amstertime/images/test"
    output_path = "/media/cartolab3/DataDisk/wuqilong_file/Projects/RerenkVPR/sample_imgs/amstertime"
    # 获取当前文件的绝对路径
    ...
    dbImages = os.path.join(parent_path, "amstertime_val_dbImages.npy")
    qImages = os.path.join(parent_path, "amstertime_val_qImages.npy")
    qIdx = os.path.join(parent_path, "amstertime_val_qIdx.npy")
    pIdx = os.path.join(parent_path, "amstertime_val_pIdx.npy")
    num_pairs = 30
