...
parser.add_argument('--vgg_pretrained', default=True, type=bool)
parser.add_argument('--topk', default=1, type=int) # 选择的topk个patch tokens
parser.add_argument('--window_size', default=8, type=int) # 窗口大小
...
parser.add_argument('--metric_loss_function', choices=['MultiSimilarityLoss', 'TripletMarginLoss'],
