...
class Dinov2Finetune(nn.Module):
    def __init__(self, backbone_size='large', finetune_last_n_layers=2, output_dim=256):
        super().__init__()
    ...
    def forward(self, x):
        ...
        # 控制输出维度
        patch_tokens= self.reduce_linear(patch_tokens)
...
if __name__ == "__main__":
    ...
    model = DinoV2Finetune(backbone_size="large", finetune_last_n_layers=2)
